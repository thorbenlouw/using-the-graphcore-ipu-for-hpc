...
Structured grids are one of the classes described by Asanov\'ic \emph{et~al} in their characterisation of the computational requirements of different parallel programming problems~\cite{dwarves}. They are commonly used in solvers for differential equations, such as those underpinning heat and fluid simulations.
...
\scriptsize{
Comparison implementations in CPU and GPU are in OpenCL v1.1. 

\begin{itemize}
    \item Intel(R) Xeon(R) Platinum 8168 (Skylake) CPUs @ 2.70GHz, 2x24 cores, 768GiB RAM
    \item IPU driver version 1.0.44, firmware version 1.3.31. Poplar SDK version v1.2.0-495c1aa368
...
\section*{Appendix B: Example vertex}
\label{app:example-vertex}
\scriptsize{
The code below shows an example Vertex, and the use of the SIMD vector types:
